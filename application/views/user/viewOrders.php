		...
		<table class="ui attached table celled segment striped compact scroll">
			<thead>
				...
				<tr>
					...
					<td class="trim"><input type="text" datepicker class="datepicker table-filter" ng-model="orderf.order_required_delivery_date"></td>
		...
		<div class="scroll nobar">
			<table class="ui attached table celled segment striped compact" style="zoom:.75">
				<tbody>
						...
						<tr ng-repeat="order in orders | filter:orderf " class="{{order.order_status}}">
							...
							<td width="20%">{{order.order_required_delivery_date | date:'fullDate'}}</td>
