	...
	<script src="<?=base_url()?>public/js/coustomer-app.js"></script>
	<script src="<?=base_url()?>public/js/ui-date.js"></script>
	...
	<script src="<?=base_url()?>public/js/coustomer-controller.js"></script>
</body>
</html>