	...
	<div class="trim wide column">
		<div class="panel panel-default">
			<div class="panel-heading clearfix">
				...
				<h3 class="panel-title pull-left">	<i class="large cube icon "></i> Edit :  {{product.product_title}}</h3>
			...
			<table class="ui definition table compact top attached">
			  <tbody>
			    ...
			    <tr>
			      ...
			      <td class="trim"><input type="text" class="table-filter" ng-model="product.product_code" disabled></td>
			    </tr>
			    <tr>
			      <td>Product Catagoy</td>
			      <td class="trim">
			      		<select name="" class="table-filter"  ng-model="product.product_category_id"  ng-options="category.product_cat_id as category.product_cat_title for category in categorys"></select>
			      </td>
			    </tr>
			    ...
			    <tr>
			      ...
			      <td class="trim">
			      		<select name="" class="table-filter"  ng-model="product.product_supplier_id"  ng-options="supplier.supplier_id as supplier.supplier_name for supplier in suppliers"></select>
			      </td>
			    </tr>
			    <tr>
			    ...
			    <tr>
			      <td></td>
			      <td>
			      	<a ng-click="updateProduct()" class="ui button blue fluid">Update Changes</a>
			      </td>
			    </tr>
